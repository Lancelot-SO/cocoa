        ...
        <div>
            ...
            <section>
                <div className='px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64'>
                    <div class="my-10 w-full h-[580px] overflow-hidden">
                        ...
                        <div class="w-full my-10 p-6 bg-white shadow-md rounded-lg">
                            <div class="flex flex-col md:flex-row md:space-x-6 lg:gap-20">
                                <div class="flex-1 mb-6 md:mb-0">
                                    ...
                                    <form class="">
                                        <div class="mb-4">
                                            <textarea class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-600" rows="4" placeholder="Enter Message"></textarea>
                                        </div>
                                        <div class="flex space-x-4 mb-4">
                                            <input type="text" class="w-1/2 p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-600" placeholder="Enter your name" />
                                            <input type="email" class="w-1/2 p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-600" placeholder="Email" />
                                        </div>
                                        <div class="mb-4">
                                            <input type="text" class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-600" placeholder="Enter Subject" />
                                        </div>
                                        <div>
